...
if kenaikan_gaji > 0:
    print(f"{nama_karyawan} ({jabatan}) dengan masa kerja {masa_kerja} tahun
        berhak mendapatkan kenaikan gaji sebesar {kenaikan_gaji}%.")
else:
    print(f"{nama_karyawan} ({jabatan}) dengan masa kerja {masa_kerja} tahun tidak berhak mendapatkan kenaikan gaji.")